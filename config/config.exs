...
config :myApi, MyApiWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "DmZq+9hgm9NnyfqOmKwMVYqIlMG/7fsbLhuZO5L6RqWwzvsOAJln4Y93ayQ7hGYd",
...
config :myApi, MyApi.Guardian,
  issuer: "myApi",
  secret_key: "cUtBWBUSwome2JYTX4QvI2bCkCfM2H8moP2Harr7lT2t4smP3FkbRoobobcRkqpL"
